...
1. Project Purpose :
   ...
   👨‍🎓  Student Academic Analysis Dashboard
   
   Used to learn insights about students score and how it varies based on certain factors.
   
3. Tech Stack :

   💻 Power bi Deskstop Application
   
   📁 .pbix to save the dashboard and .png to store a snapshot of the dashboard
